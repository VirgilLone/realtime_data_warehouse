...
import com.atguigu.gmall.realtime.app.func.ConfigTableProcessFunction;
...
public class BaseDBApp {
    public static void main(String[] args) throws Exception {
        ...
        // 如果说启动了Checkpoint，而没有重启策略，那么重启策略默认会尝试自动帮你进行重启   重启Integer.MaxValue
        ...
        SingleOutputStreamOperator<JSONObject> kafkaDS = filteredDS.process(
            new ConfigTableProcessFunction(hbaseTag)
        );
        ...
        FlinkKafkaProducer<JSONObject> kafkaSink = MyKafkaUtil.<JSONObject>getKafkaSinkBySchema(
