...
//                accumulator.setPv_ct(accumulator.getPv_ct()+value.getPv_ct());
//                accumulator.setUv_ct(accumulator.getUv_ct()+value.getUv_ct());
//                accumulator.setSv_ct(accumulator.getSv_ct()+value.getSv_ct());
//                accumulator.setDur_sum(accumulator.getDur_sum()+value.getDur_sum());
//                return accumulator;
//            }
//
//            @Override
...
//                a.setPv_ct(a.getPv_ct()+b.getPv_ct());
//                a.setUv_ct(a.getUv_ct()+b.getUv_ct());
//                a.setSv_ct(a.getSv_ct()+b.getSv_ct());
//                a.setDur_sum(a.getDur_sum()+b.getDur_sum());
//                return a;
//            }
